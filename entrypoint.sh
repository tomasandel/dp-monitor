...
# -stdout: route notifications to stdout (visible via docker logs); errors go to stderr unconditionally
certspotter -state_dir /var/lib/certspotter -watchlist /var/lib/certspotter/watchlist -logs "${CT_LOG_LIST_URL}" -start_at_end -stdout &
CERTSPOTTER_PID=$!
